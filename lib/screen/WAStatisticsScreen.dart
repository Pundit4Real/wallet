...
import 'package:wallet_app_prokit/component/WACategoriesComponent.dart';
import 'package:wallet_app_prokit/component/WAStatisticsChartComponent.dart';
import 'package:wallet_app_prokit/component/WAStatisticsComponent.dart';
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
            backgroundColor: Colors.transparent, title: Text('Statistics', style: boldTextStyle(color: Colors.black, size: 20)), centerTitle: true, automaticallyImplyLeading: false, elevation: 0.0, systemOverlayStyle: SystemUiOverlayStyle.dark),
        body: Container(
