...
import 'package:wallet_app_prokit/component/WASendViaComponent.dart';
import 'package:wallet_app_prokit/model/WalletAppModel.dart';
import 'package:wallet_app_prokit/screen/WADashboardScreen.dart';
import 'package:wallet_app_prokit/utils/WAColors.dart';
import 'package:wallet_app_prokit/utils/WAMultiplePointedEdgeClipper.dart';
import 'package:wallet_app_prokit/utils/WAMySeperator.dart';
          ...
          child: SingleChildScrollView(
            child: Stack(
              ...
              children: [
                ...
                Image.asset('images/walletApp/wa_credit_card_bg.png', height: 200, width: 200, fit: BoxFit.cover),
              ],
            ),
          ),
        ),
