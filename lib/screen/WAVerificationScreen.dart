                ...
                children: [
                  SizedBox(
                      ...
                      child: OTPTextField(
                        pinLength: 4,
                        fieldWidth: 40,
                        textStyle: boldTextStyle(size: 24, color: appStore.isDarkModeOn ? white : black),
                        decoration: InputDecoration(
                          fillColor: appStore.isDarkModeOn ? cardDarkColor : Colors.grey.withOpacity(0.1),
                          filled: true,
                          border: OutlineInputBorder(borderSide: BorderSide(color: Colors.transparent)),
                          focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: WAPrimaryColor)),
                        ),
                        onChanged: (value) {},
                        onCompleted: (value) {},
                      )),
