              ...
              bottomTitles: AxisTitles(
                sideTitles: SideTitles(
                  ...
                  getTitlesWidget: (value, meta) {
                    switch (value.toInt()) {
                      case 0:
                        return Text('Mn', style: primaryTextStyle());
                      case 1:
                        return Text('Te', style: primaryTextStyle());
                      case 2:
                        return Text('Wd', style: primaryTextStyle());
                      case 3:
                        return Text('Tu', style: primaryTextStyle());
                      case 4:
                        return Text('Fr', style: primaryTextStyle());
                      case 5:
                        return Text('St', style: primaryTextStyle());
                      case 6:
                        return Text('Sn', style: primaryTextStyle());
                      default:
